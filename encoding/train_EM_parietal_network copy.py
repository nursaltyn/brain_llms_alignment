...
if __name__ == "__main__":
    ...
    parser.add_argument("--area", type = list, default=["roi_mask_IPS", "roi_mask_cIPL"]) #layer from 0 to 11
    ...
    rresp = get_resp(resp_path, args.subject, stories, stack=True, area=args.area, mode=args.mode, split=args.split)
    ...
    if args.split == 'train':
        ...
        save_location = os.path.join(config.RESULT_DIR, args.subject, "parietal_network")
