...
if __name__ == "__main__":
    ...
    parser.add_argument("--area", type = list, default=["roi_mask_Broca", "roi_mask_AC", "roi_mask_sPMv"]) #layer from 0 to 11
    ...
    save_location = os.path.join(config.RESULT_DIR, args.subject, "speech_network")
