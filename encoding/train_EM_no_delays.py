...
if __name__ == "__main__":
    ...
    resp_path = r"C:data_train/train_response"
    ...
    rstim, tr_stats, word_stats = get_stim(stories, features, make_delay=False)
    ...
    save_location = os.path.join("without_delay/", args.subject, area_name)
